...
package org.opengroup.osdu.file.aws.validation;
...
@Primary
@Component
public class AwsFileLocationRequestValidator extends CommonFileLocationRequestValidator {

  private static final String FILE_ID_MAX_GCP_LENGTH =
      "length should be less than resulted GCS filepath. Max: ${max_length}";

  public AwsFileLocationRequestValidator(FileIdValidator fileIdValidator) {
