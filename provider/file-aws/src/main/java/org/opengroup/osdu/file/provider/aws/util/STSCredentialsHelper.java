...
public class STSCredentialsHelper {
    ...
    @Autowired
    public STSCredentialsHelper(AwsServiceConfig awsServiceConfig, InstantHelper instantHelper) {
        this.instantHelper = instantHelper;

        final STSConfig config = new STSConfig(awsServiceConfig.amazonRegion);
        this.sts = config.amazonSTS();
    }
    ...
    private Policy createUploadPolicy(S3Location fileLocation) {
        ...
        String resource4 = String.format("arn:aws:s3:::%s/%s/*", fileLocation.bucket,
                                         fileLocationKeyWithoutTrailingSlash);
        ...
        return policy.withStatements(listBucketStatement, listBucketSubPathStatement, allowUploadStatement,
                                     allowUploadSubPathStatement);
    }
    ...
    private TemporaryCredentials getCredentials(Policy policy, String roleArn, String user, Date expiration) {
