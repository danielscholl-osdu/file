...
@Primary
@Component
public class GcFileLocationRequestValidator extends CommonFileLocationRequestValidator {
  ...
  public GcFileLocationRequestValidator(FileIdValidator fileIdValidator) {
