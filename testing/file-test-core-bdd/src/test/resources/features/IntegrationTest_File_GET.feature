Feature: File service API integration test
  ...
  Scenario Outline: Verify that File service's GET upload-url API throws correct exception if mandatory headers are blank or invalid
    ...
    Examples: 
      | ReponseStatusCode | ResponseMessage                                        | header              | headerValue    |
      | "401"             | "/output_payloads/FileGET_MissingAuthorization.json"   | "authorization"     | ""             |
      | "401"             | "/output_payloads/FileGET_UnAuthUserExcp.json"         | "authorization"     | "ExpiredToken" |
      | "401"             | "/output_payloads/FileGET_MissingDataPartitionId.json" | "data-partition-id" | ""             |
      | "401"             | "/output_payloads/FileGET_UnAuthUserExcp.json"         | "data-partition-id" | "incorrectDPI" |
