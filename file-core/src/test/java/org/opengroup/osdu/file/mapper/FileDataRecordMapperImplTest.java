...
public class FileDataRecordMapperImplTest {
    ...
    @Test
    public void recordToRecordVersionTest() throws ApplicationException {
        fileDataRecordMapper = new FileMetadataRecordMapper(new ObjectMapper());
        Record record = getRecordObj();
        JsonObject jsonObject = new JsonObject();
        Gson gson = new GsonBuilder().create();
        jsonObject = gson.fromJson(FILE_DATA, JsonObject.class);
    ...
    @Test
    public void recordToRecordVersionWithMetaBlockTest() throws ApplicationException {
        fileDataRecordMapper = new FileMetadataRecordMapper(new ObjectMapper());
        Record record = getRecordObj();
        JsonObject jsonObject = new JsonObject();
        Gson gson = new GsonBuilder().create();
        jsonObject = gson.fromJson(FILE_DATA, JsonObject.class);
        record.setData(jsonObject);
        List<JsonObject> meta = new ArrayList<>();
        meta.add(jsonObject);
        record.setMeta(meta);
        RecordVersion recordVersion = fileDataRecordMapper.recordToRecordVersion(record);
    ...
    public void fileMetadataToRecordJsonParseError() throws ApplicationException {
        fileDataRecordMapper = new FileMetadataRecordMapper(new ObjectMapper());
        FileMetadata fileMetadata = FileMetadata.builder().id(RECORD_ID).kind(KIND).build();
    ...
    @Test
    public void recordToRecordVersionParseError() throws ApplicationException {
        fileDataRecordMapper = new FileMetadataRecordMapper(new ObjectMapper());
        Record record = getRecordObj();
        JsonObject jsonObject = new JsonObject();
        Gson gson = new GsonBuilder().create();
    ...
    @Test
    public void recordToRecordVersionWithTagsTest() throws ApplicationException {
        fileDataRecordMapper = new FileMetadataRecordMapper(new ObjectMapper());
        Record record = getRecordObj();
        JsonObject jsonObject = new JsonObject();
        Gson gson = new GsonBuilder().create();
